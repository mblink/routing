...
object Build {
  ...
  object Http4sAxis extends Enumeration {
    ...
    val v0_23 = HAVal("0.23", proj => Def.setting("org.http4s" %%% s"http4s-$proj" % "0.23.36"), "latest stable on cats effect 3")
    val v1_0_0_M46 = HAVal(s"${http4sV1Milestone}46", proj => Def.setting("org.http4s" %%% s"http4s-$proj" % "1.0.0-M47"), "latest development on cats effect 3")
